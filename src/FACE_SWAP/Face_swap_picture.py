...
if len(destination_faces) == 1:
    ...
    for i, triangle_index_points in enumerate(triangle_landmark_points_list):
        ...
        cv2.line(source_face_image, source_triangle_point_1, source_triangle_point_2, (0, 255, 0), 1)
        cv2.line(source_face_image, source_triangle_point_2, source_triangle_point_3, (0, 255, 0), 1)
        cv2.line(source_face_image, source_triangle_point_1, source_triangle_point_3, (0, 255, 0), 1)
